...
(async () => {
  ...
  if (new URLSearchParams(location.search).has('dev')) {
    ...
    for (const src of ['/js/dev/dev-auth.js', '/js/dev/dev-drag.js', '/js/dev/dev-picker.js', '/js/dev/dev-editor.js', '/js/dev/dev-layout.js', '/js/dev/dev-media.js', '/js/dev/dev-controller.js', '/js/dev/dev-config.services.js']) {
